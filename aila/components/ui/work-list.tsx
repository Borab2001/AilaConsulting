    ...
    return (
        <figure
            className={cn(
                ...
                // light styles
                'bg-element [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)]',
                // dark styles
        ...
        >
            <div className="flex flex-row items-center gap-3">
                ...
                <div className="flex flex-col overflow-hidden">
                    ...
                    <p className="text-sm text-left text-subtitle font-normal dark:text-white/60">
                        {description}
                    </p>
                </div>
            </div>
