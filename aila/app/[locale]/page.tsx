	...
	return (
		<BentoLayout gridVariants={gridVariants}>
			...
			<div className="col-span-4 row-span-9 grid grid-cols-subgrid grid-rows-subgrid max-lg:col-span-full max-lg:grid-rows-none max-lg:gap-4 flex-grow-0 overflow-y-hidden">
				...
				{/* Grid Child 3 */}
				<motion.div 
					className="min-h-[600px] md:min-h-[320px] lg:min-h-0 col-span-4 row-span-8 max-lg:col-span-full bg-bento border border-border rounded-2xl w-full flex flex-grow-0 overflow-y-hidden flex-col justify-between"	
					custom={2}
					initial="hidden"
					animate="visible"
					variants={gridVariants}	
