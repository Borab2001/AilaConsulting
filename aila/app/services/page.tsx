    ...
    return (
        <main className="flex flex-1 flex-grow h-full pt-16 md:pt-0">
            ...
            <div className='grid h-full min-h-[700px] grid-cols-12 grid-rows-10 gap-4 max-lg:h-auto max-lg:grid-rows-none'>
                ...
                {/* Left column */}
				<div className="col-span-6 row-span-9 grid grid-cols-subgrid grid-rows-subgrid max-lg:col-span-full max-lg:grid-rows-none max-lg:gap-4">
                    <motion.div 
					...
					>
                        ...
                        <div className="flex-1 w-auto h-auto absolute -right-1/4 -bottom-1/4">
                            <Globe />
                        </div>
                    </motion.div>
                </div>
